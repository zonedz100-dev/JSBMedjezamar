...
import { SportsMagazineHero } from './components/SportsMagazineHero';
import { MatchHighlightsPlayer } from './components/MatchHighlightsPlayer';
      ...
      <main className="flex-grow">
        ...
        {activeTab === 'home' && (
          <div className="space-y-12">
            ...
            {/* 1. Sports Magazine News Layout (Inspired by merr1.png) */}
            <section className="max-w-7xl mx-auto px-4 md:px-8">
              <SportsMagazineHero
            ...
            {/* 2. Video Highlights & Match Center Player (Directly from merr1.png) */}
            <section id="highlights-section" className="max-w-7xl mx-auto px-4 md:px-8">
              <MatchHighlightsPlayer
                onOpenMatchCenter={() => setIsMatchCenterOpen(true)}
              />
            </section>
